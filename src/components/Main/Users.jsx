...
class Users extends React.Component {
  ...
  setPagination = currentPage => {
    ...
    let tmpUsers = this.state.users.slice(
  ...
  setFilter = filter => {
    ...
    if (filter.length) {
      let filterUsers = this.state.users.filter(
        user =>
          user.email
            .toString()
            .toLowerCase()
                ...
                return (
                  <div key={index} className="col-md-3 col-sm-12">
                    <div className="card mx-auto mt-2">
                      <img
                        className="card-img-top img-responsive mx-auto"
                        src={logo}
                        alt="Card"
                        style={{ width: "50%" }}
                      />
                      ...
                      <div className="card-body">
                        ...
                        <span className="input-group-btn">
                          ...
                          >
                            <span>
                              <li className="fas fa-trash-alt" /> Delete
                            </span>
                          </button>
                        </span>
                      </div>
